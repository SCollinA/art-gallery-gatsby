                    ...
                    <div className='commissionProcess'>
                        ...
                        <div>
                            ...
                            {(randomArtworks[3].file && 
                                <Img fluid={randomArtworks[3].file.childImageSharp.fluid}/>) ||
                            (randomArtworks[3].image &&
                                <img src={randomArtworks[3].image} alt='a random selection from artworks'/>)}
                        </div>
                        <div>
                            <h6>Payment</h6>
                            <p>
                            ...
                            {(randomArtworks[4].file && 
                                <Img fluid={randomArtworks[4].file.childImageSharp.fluid}/>) ||
                            (randomArtworks[4].image &&
                                <img src={randomArtworks[4].image} alt='a random selection from artworks'/>)}
                        </div>
                        <div>  
                            <p>
